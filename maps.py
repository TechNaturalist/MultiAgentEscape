...
class Map1:
    def __init__(self):
        self.size = 20
        self.walls = [(0, 4), (1, 4), (2, 4), (3, 4), (4, 4), (8, 4), (9, 4), (10, 4), (11, 4), (12, 4), (13, 4), (14, 4),
        ...
        self.guards = [GuardAgent((1, 6)), GuardAgent((14, 10)), GuardAgent((1, 14))]
        self.player = PlayerAgent((10, 18))
        self.human = HumanAgent((10, 18))
        self.door = (0, 1)
...
class Map2:
    def __init__(self):
        self.size = 20
        self.walls = [(16, 0), (16, 1), (16, 2), (3, 3), (4, 3), (5, 3), (6, 3), (7, 3), (8, 3), (9, 3), (10, 3), (11, 3),
        ...
        self.guards = [GuardAgent((14, 1)), GuardAgent((5, 5)), GuardAgent((1, 17))]
        self.player = PlayerAgent((18, 1))
        self.human = HumanAgent((18, 1))
        self.door = (1, 19)
...
class Map3:
    def __init__(self):
        self. size = 20
        self.walls = [(4, 3), (5, 3), (6, 3), (7, 3), (8, 3), (9, 3), (10, 3), (11, 3), (12, 3), (13, 3), (14, 3), (15, 3),
        ...
        self.guards = [GuardAgent((1, 1)), GuardAgent((1, 18)), GuardAgent((18, 18))]
        self.player = PlayerAgent((10, 8))
        self.human = HumanAgent((10, 8))
        self.door = (0, 14)
...
class Map4:
    def __init__(self):
        self.size = 20
        self.walls = [(6, 0), (7, 0), (13, 0), (17, 0), (5, 1), (17, 1), (2, 2), (9, 2), (4, 3), (14, 3), (16, 3), (2, 4),
             ...
             (17, 18), (11, 19), (19, 19)]
        self.guards = [GuardAgent((5, 5)), GuardAgent((17, 7)), GuardAgent((10, 17))]
        self.player = PlayerAgent((0, 17))
        self.human = HumanAgent((0, 17))
        self.door = (15, 0)
...
class Map5:
    def __init__(self):
        self.size = 20
        self.walls = [(10, 0), (18, 0), (1, 1), (10, 1), (14, 1), (17, 1), (18, 1), (4, 2), (7, 2), (10, 2), (12, 2), (14, 2),
        ...
        self.guards = [GuardAgent((0, 0)), GuardAgent((10, 9)), GuardAgent((19, 19))]
        self.player = PlayerAgent((19, 0))
        self.human = HumanAgent((19, 0))
        self.door = (0, 19)
