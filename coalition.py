...
class Coalition:
    ...
    def calculate_coalition_utility(self, potential_members: List[GuardAgent])\
            -> float:
        utility = 0
        ...
        # The total utility is the utility of each potential member divided by
        # the number of people ^ 1.3
